...
def main(debug=False, solver="FD_fixed"):
    ...
    C_total = hm.create_connectivity_matrix(n, e)

    C, C_f = hm.partition_connectivity_matrix(C_total, n_f)
    ...
    hl.debug_struct_input(n, e, e_l, n_l, n_f)
    hl.debug_struct_matrices(C_total, C, C_f, p_x, p_y, p_z)
